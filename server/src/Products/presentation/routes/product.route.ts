import { CreateProductService,UpdateProductService,DeleteProductService,GetAllProductsService,GetProductByIdService,GetProductByNameService } from "../../application/services";
...
export class ProductRoutes {
    static get routes():Router {
        ...
        const createProductService = new CreateProductService(productRepository, categoryRepository);
        const updateProductService = new UpdateProductService(productRepository, categoryRepository);
