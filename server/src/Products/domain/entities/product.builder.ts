...
const requiredProductsFields = ["name", "description", "price", "categoryId"];
...
export class ProductBuilder {
  ...
  from(existingProduct: Product): ProductBuilder {
  ...
  build(): Product {
    if (
      ...
      throw new ValidationError({
        fields: [
          `Missing required fields: ${requiredProductsFields.join(", ")}`,
        ],
      });
    }
    return this.product;
