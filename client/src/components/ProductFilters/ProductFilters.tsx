...
const ProductFilters = ({filters, setFilters, products, productsStatus, categoryId}:Props) => {
    const categories = categoryId ? [categoryId] :
     [...new Set(products?.map(p => p.categoryId) || [])];
    const sizes = [...new Set(
      products?.flatMap(p => p.sizes?.map(s => s.name)) || []
    )];
    ...
    return (
        ...
        <CardContent className="pt-6">
          <div className="space-y-6">
            ...
            {/* Categorías */}
            <div className="space-y-2">
              <Label htmlFor="category">Categoría {isUnicCategory ? `: ${categories[0]}` : ""}</Label>
              {!isUnicCategory &&(<Select
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem value="best-discount">Mejores descuentos</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </div>
